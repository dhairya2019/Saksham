					  ...
					  <!-- breadcrumb -->
                        ...
                        <div id="block_bg" class="block">
                            ...
                            <div class="block-content collapse in">
								...
								<button><a href="<?php echo $z->start_url ?>" >Create Session</a></button>

								


								<!-- <a href= $z->start_url name="create class" class="btn btn-info"><i class="icon-check icon-large"></i> create class</a> -->


								<!-- <a href="https://us04web.zoom.us/s/73529160454?zak=eyJ6bV9za20iOiJ6bV9vMm0iLCJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9..9why0eyeoOtVvdYyU-f9QCxqoQJB_E0scD7wxSsV2EM" name="create class" class="btn btn-info"><i class="icon-check icon-large"></i> create class</a> -->
								</form>
                                </div>
								...
								<?php
									...
									$x=$z->join_url;
									// echo $x;
									$content1 ='<a class="zoom_link" href=';									
									$content2= '>Join Zoom Class</a>';
