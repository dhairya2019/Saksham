...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 24, 2021 at 11:02 PM
...
(1, 'SCHOOL OF COMPUTER SCIENCE', 'Dr Abhirup Kumar');
...
(145, 'admin/uploads/9210_File_8-context free grammar.pdf', '2021-03-25 03:04:36', 'dhairya', 1, 190, 'dhairya', 'RamanKumar'),
(146, 'admin/uploads/3354_File_8-context free grammar.pdf', '2021-03-25 03:19:40', 'Learn', 1, 200, 'CFG', 'AbhirupKhanna'),
(147, 'admin/uploads/5805_File_8-context free grammar.pdf', '2021-03-25 03:22:18', 'Do it', 1, 200, 'CFG', 'AbhirupKhanna'),
(148, 'admin/uploads/3374_File_8-context free grammar.pdf', '2021-03-25 03:29:17', 'Do it carefully', 1, 201, 'CFG', 'AbhirupKhanna');
...
(27, 190, 'Add Downloadable Materials file name <b>dhairya</b>', '2021-03-25 03:04:36', 'downloadable_student.php'),
(28, 200, 'Add Downloadable Materials file name <b>CFG</b>', '2021-03-25 03:19:40', 'downloadable_student.php'),
(29, 200, 'Add Downloadable Materials file name <b>CFG</b>', '2021-03-25 03:22:18', 'downloadable_student.php'),
(30, 201, 'Add Downloadable Materials file name <b>CFG</b>', '2021-03-25 03:29:17', 'downloadable_student.php');
...
(1, 'Dhairya', 'Chugh', 1, 'dhairya', '123', 'uploads/avatar.jpg', 'Registered'),
(2, 'Sachin', 'Agrawal', 1, 'sachin', '123', 'uploads/avatar.jpg', 'Registered'),
(3, 'Raghav', 'Jindal', 2, 'raghav', '123', 'uploads/avatar.jpg', 'Registered'),
(4, 'Raman', 'Kumar', 2, 'raman', '123', 'uploads/avatar.jpg', 'Registered');
...
(2, '2', 'Data Structures', 'Coding', '', 3, '', '4th'),
(1, '1', 'Cloud Application Development', 'Cloud Computing', '', 3, '', '6th');
...
(1, 'abhirup', '123', 'Abhirup', 'Khanna', 1, 'uploads/avatar.jpg', '', 'Registered', 'Activated');
...
(200, 1, 1, 1, 'admin/uploads/thumbnails.jpg', '2018-2022'),
(201, 1, 2, 2, 'admin/uploads/thumbnails.jpg', '2018-2022');
...
--
ALTER TABLE `teacher_class`
  MODIFY `teacher_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=202;
...
--
ALTER TABLE `teacher_class_student`
  MODIFY `teacher_class_student_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=404;
