            ...
            <div class="row-fluid">
                ...
                <div class="span4" id="content">
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							    <div id="" class="muted pull-left mycss"><h4> Assignment Grade Progress</h4></div>
							</div>
                     ...
                     <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
							    <div id="" class="muted pull-left mycss"><h4> Practice Quiz Progress</h4></div>
							</div>
                            <div class="block-content collapse in">
                                <div class="span12">
